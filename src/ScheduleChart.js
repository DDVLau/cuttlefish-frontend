...
function ScheduleChart({ tasks, schedule_start, view_min, view_max, colorGrey=false}) {
    ...
    return (
        <Bar
            datasetIdKey={"label"}
            data={{
                labels: ["Washer", "Dryer", "Dishwasher", "Vehicle", "Battery"],
                datasets: [
                    {
                        label: "Appliance on",
                        data: appliance_data,
                        backgroundColor: cssColour(colorGrey?CHARTJS_HEX.seventh:CHARTJS_HEX.first, 0.4),
                        borderColor: cssColour(colorGrey?CHARTJS_HEX.seventh:CHARTJS_HEX.first, 1.0),
                        borderWidth: 3,
                        borderSkipped: false,
                    },
                    {
                        ...
                        backgroundColor: cssColour(CHARTJS_HEX.second, 0.4),
                        borderColor: cssColour(CHARTJS_HEX.second, 1.0),
                        borderWidth: 3,
                        borderSkipped: false,
                    },
                    {
                        ...
                        backgroundColor: cssColour(CHARTJS_HEX.sixth, 0.4),
                        borderColor: cssColour(CHARTJS_HEX.sixth, 1.0),
                        borderWidth: 3,
                        borderSkipped: false,
                    },
                ],
